<?php include 'db.php';
session_start();
$payrollQuery = mysqli_query($db, "SELECT * FROM payslip INNER JOIN employees ON payslip.employee_id = employees.employee_id WHERE employees.employee_id = '" . $_SESSION['employee_id'] . "'");
